...
class PPO():
    ...
    def update(self, rollouts, drug_idx_to_original_map, do_constrained):
        ...
        for e in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                ...
                prob_sums = torch.zeros(unique_actions.shape, dtype=torch.float)
                ...
                ranks = torch.arange(1, len(sorted_actions) + 1, dtype=torch.float)
